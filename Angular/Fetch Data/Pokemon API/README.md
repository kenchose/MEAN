...
2. Print the most interesting data about your Pokemon in a string
3. Using the data from your first API call, construct another API call
4. Print how many Pokemon share your favorite Pokemon's abilities
